        ...
        <main className="admin-content">
          ...
          <div className="row g-3 mb-4">
            {[
              ...
              { title: "Revenue", value: "₹8,450", icon: "currency-rupee", color: "success" },
              { title: "Pending", value: "6", icon: "clock-history", color: "warning" },
              { title: "Foods", value: "85", icon: "fork-knife", color: "dark" },
            ].map((item, index) => (
              <div className="col-6 col-md-3" key={index}>
                <div className={`card text-center shadow-sm border-${item.color}`}>
              ...
              <table className="table table-hover text-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Rahul</td>
                    <td>450</td>
                    <td><span className="badge bg-info text-dark">Out</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
